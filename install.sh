...
if [[ $(basename "$PWD") != "zen-bookmark"* ]]; then
  git clone https://github.com/alex1701c/zen-bookmark
  cd zen-bookmark/
fi
...
echo "zen-bookmark installation finished! You can now use 'zen' or 'zb' in KRunner to search Zen browser bookmarks.";
